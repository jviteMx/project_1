...
class UserInterface:
    ...
    def insert_documents_to_db(self):
        ...
        df_traffic_v16.columns = ['secname','the_geom','year_vol','shape_leng','volume']
        ...
        df_traffic_v17 = df_traffic_v17[['segment_name','the_geom','year','length_m','volume']]
        df_traffic_v17.columns = ['secname','the_geom','year_vol','shape_leng','volume']
        ...
        df_traffic_v18 = df_traffic_v18[['SECNAME','multilinestring','YEAR','Shape_Leng','VOLUME']]
        df_traffic_v18.columns = ['secname','the_geom','year_vol','shape_leng','volume']
        #df = df[['favorite_color','grade','name','age']]
        traffic_v18.insert_many(df_traffic_v18.to_dict('records')) 
        print(df_traffic_v18.head(2)) 
        ...
        filt_16 = df_traffic_iall.START_DT.str.contains(pat = '2016')
        df_traffic_i16 = df_traffic_iall[filt_16]
        traffic_i16.insert_many(df_traffic_i16.to_dict('records'))

        traffic_i17 = db.traffic_i17                 #traffic_i17 collection
        df_traffic_iall = pd.read_csv("Traffic_Incidents.csv")
        filt_17 = df_traffic_iall.START_DT.str.contains(pat = '2017')
        df_traffic_i17 = df_traffic_iall[filt_17]
        ...
        #print(df_traffic_i18.head(10))  # print head to confirm if all are 2018
    ...
    def analyze_and_plot(self):# chart is ok
        ...
        elif self.n1.get()=='Trafic Accidents':  
            pass
